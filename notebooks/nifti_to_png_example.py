...
# %%
TEST_FOLDER = Path("/mnt/Samsung SSD/nifti_tests/annotation4_completed")
study_dirs = [TEST_FOLDER / "4", TEST_FOLDER / "12"]

example_dir = TEST_FOLDER / "4" / "WC-ADPKD_BD9-000383MR3-AX SSFSE ABD PEL "
...
# %%
# previous data
png = "/mnt/Samsung SSD/vast_ai_mirror/training_data-61-110MR_AX_SSFSE_ABD_PEL_50/WC-ADPKD_AB9-001467-MR1/Ground/00022_2.16.840.1.113669.632.21.1761676154.1761676154.36448706562526961.png"  # noqa
dcm = "/mnt/Samsung SSD/vast_ai_mirror/training_data-61-110MR_AX_SSFSE_ABD_PEL_50/WC-ADPKD_AB9-001467-MR1/DICOM_anon/00022_2.16.840.1.113669.632.21.1761676154.1761676154.36448706562526961.dcm"  # noqa
...
diff_example_dir = Path(
    "/mnt/Samsung SSD/nifti_tests/WC-ADPKD_KJ9-002316MR3-AXL FIESTA "
)  # noqa
...
test_target_dir = Path("/mnt/Samsung SSD/nifti_tests/parsed_studies")
process_nifti_dirs(TEST_FOLDER, test_target_dir)

# %%
# checks
test_dcm = "/mnt/Samsung SSD/nifti_tests/parsed_studies/WC-ADPKD_AM9-002358MR1-AXL FIESTA /DICOM_anon/00010_2.16.840.1.113669.632.21.136842060.136842060.7615641522567231422.dcm"  # noqa
...
# %%
# REAL RUN
real_source = Path("/mnt/Samsung SSD/data/annotation_completed")
real_target = Path("/mnt/Samsung SSD/data/processed_studies")
